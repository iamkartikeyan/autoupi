...
// Initial fallback mock bank accounts (4 Major Indian Banks: SBI, HDFC, Union, Kotak > 5 Lakh balance)
...
// Initial fallback beneficiaries matching Google Pay Screenshot
const INITIAL_BENEFICIARIES: Beneficiary[] = [
  {
    id: 'ben_kartikeyan',
    userId: 'usr_auto_889210',
    name: 'kartikeyan sahani',
    upiIdOrHandle: 'kartikeyan@oksbi',
    avatarUrl: '',
    initials: 'K',
    country: 'India',
    countryCode: 'IN',
    ...
    bankName: 'State Bank of India',
    accountNumberMasked: '•••• 6492',
    routingIdentifier: 'SBIN0006492',
    phoneOrEmail: '+91 77039 16321',
    verificationState: 'VERIFIED',
    isFavorite: true,
    lastTransferDate: new Date(Date.now() - 3600000).toISOString(),
  },
  {
    id: 'ben_rahul',
    userId: 'usr_auto_889210',
  ...
  },
  {
    ...
    verificationState: 'VERIFIED',
    isFavorite: true,
    lastTransferDate: new Date(Date.now() - 86400000).toISOString(),
  },
  {
    id: 'ben_rahulk',
    userId: 'usr_auto_889210',
    name: 'Rahul Kumar',
    upiIdOrHandle: 'rahulk@oksbi',
    avatarUrl: '',
    initials: 'R',
    country: 'India',
    countryCode: 'IN',
    ...
    routingIdentifier: 'SBIN0001234',
    phoneOrEmail: '+91 98101 23456',
    verificationState: 'VERIFIED',
    isFavorite: true,
  },
  {
  ...
  },
  {
    ...
    userId: 'usr_auto_889210',
    name: 'Neerendra.',
    upiIdOrHandle: 'neerendra@okaxis',
    ...
    currency: 'INR',
    bankName: 'Axis Bank',
    accountNumberMasked: '•••• 8234',
    routingIdentifier: 'UTIB0008800',
    phoneOrEmail: '+91 88001 98234',
    verificationState: 'VERIFIED',
    isFavorite: true,
  },
  {
    ...
    bankName: 'ICICI Bank',
    accountNumberMasked: '•••• 4567',
    routingIdentifier: 'ICIC0009911',
    phoneOrEmail: '+91 99112 34567',
    verificationState: 'VERIFIED',
    isFavorite: true,
  },
  {
